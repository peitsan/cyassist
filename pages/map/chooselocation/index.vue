    ...
    <view class="location-wrapper">
        <view class="location-search">
            ...
            <view class="clear" v-show="searchContent" @click="clearSearchChange">
                <image mode="widthFix" src="/static/chooselocation/close-icon.png">
            </view>
        </view>
        ...
        <view class="loading-animation" v-show="loading">
            <image mode="widthFix" src="/static/chooselocation/loading-icon.png">检索中
        </view>
    </view>
</template>
    ...
    onLoad () {
        ...
        uni.getLocation({
            ...
            success (response) {
                ...
                that.centerFunc();
                that.markerFunc();
                let address = that.mapCurrentPoint.address.province + 
    ...
    methods: {
        ...
        searchPointChange () {
            ...
            if (this.searchType === 0) {
                ...
                search.poiSearchNearBy( '', new plus.maps.Point( this.mapCurrentPoint.longitude, this.mapCurrentPoint.latitude ), 3000, this.pageCurrent);
            }
            this.loading = true;
